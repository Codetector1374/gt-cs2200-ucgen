...
div0: [gImm, p2mux=0, amux=0, immctrlsel=1, LdA, LdB] div1
div1: [aluop=9, gALU, wrreg, ldflags] fetch0

mod0: [gImm, p2mux=0, amux=0, immctrlsel=1, LdA, LdB] mod1
mod1: [aluop=10, gALU, wrreg, ldflags] fetch0
...
out1: [p2mux=1, gP2, driodataext, iowe=1] out2      // TODO: Check if we need this
out2: [p2mux=1, gP2, driodataext, io, iowe=1] fetch0

in0: [gImm, LdIOAddr, iowe=0] in1
in1: [io] in2                                       // TODO: Check if we need this
in2: [io, LdIOData] in3
...
// DR   |   BaseR / SP (SR1)    |   Imm
push0: [amux=0, LdA, LdB1, LdB] push1               // Load SP A, Load 1 into B
push1: [aluop=4, gALU, LdMAR, WrREG, WrSR] push2    // SP <- SP - 1, SP--
push2: [p2mux=1, gP2, WrMEM] fetch0                 // MEM[SP] <- DR
...
lw2: [] lw3                         // TODO: Do we need this? Wait one cycle after LdMAR to read from it
